...
public:
    edgeTailPktDelayLstfClass()
        : TclClass("Queue/edgeTailPktDelayLstf")
    {
    }
...
edgeTailPktDelayLstfQueue::edgeTailPktDelayLstfQueue()
    : srcid_(-1)
    , tchan_(0)
{
...
void edgeTailPktDelayLstfQueue::trace(TracedVar* v)
{
    const char* p;
